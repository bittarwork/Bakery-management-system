    ...
    const loadInitialData = async () => {
        try {
            ...
            if (history.length === 0 && config.welcomeMessage) {
                ...
                aiChatService.addToHistory('ai', config.welcomeMessage, { isWelcome: true });
            }
    ...
    const handleClearChat = () => {
        if (window.confirm('هل أنت متأكد من أنك تريد مسح سجل المحادثة؟')) {
            ...
            if (chatConfig?.welcomeMessage) {
                ...
                setMessages([welcomeMessage]);
                aiChatService.addToHistory('ai', chatConfig.welcomeMessage, { isWelcome: true });
            }
        }
    };
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h1 className="text-xl font-bold text-gray-900">
                                    {chatConfig?.botName || 'المساعد الذكي'}
                                </h1>
                                <p className="text-sm text-gray-600">
                                    مساعدك الشخصي لنظام إدارة المخبز
                                </p>
                            </div>
                        </div>
