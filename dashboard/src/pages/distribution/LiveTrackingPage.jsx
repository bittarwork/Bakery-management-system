  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
          ...
          <div className="flex items-center justify-between py-4">
            <div className="flex items-center">
              ...
              <div className="mr-4">
                <h1 className="text-2xl font-bold text-gray-900 flex items-center">
                  <Navigation className="w-7 h-7 text-green-600 ml-3" />
                  التتبع المباشر
                </h1>
                <p className="text-gray-600 mt-1">
                  تتبع مباشر لمواقع الموزعين وحالة التسليم
                </p>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <div className="flex items-center bg-green-100 rounded-lg p-2">
                ...
                <span className="text-sm font-medium text-green-800">مباشر</span>
              </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <LiveDistributorTracking selectedDate={new Date().toISOString().split("T")[0]} />
      </div>
    </div>
  );
};
