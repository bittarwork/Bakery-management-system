...
import { DashboardEnhancedActions } from "../../components/orders/EnhancedOrderActions";
        ...
        <Card>
          <CardHeader>
            ...
            <p className="text-sm text-gray-600">
              الوصول السريع للميزات الجديدة في النظام - التسعير الديناميكي
              وإدارة الموزعين وجدولة التسليم
            </p>
          </CardHeader>
          <CardBody>
            <DashboardEnhancedActions />
          </CardBody>
        </Card>
      </div>
              ...
              {quickActions.map((action, index) => {
                ...
                return (
                  ...
                  >
                    <Button
                      variant="outline"
                      className="w-full justify-start h-auto p-4 border-2 border-gray-200 hover:border-blue-300 bg-white hover:bg-blue-50 text-gray-900 hover:text-blue-900"
