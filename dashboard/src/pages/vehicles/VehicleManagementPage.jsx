...
const VehicleManagementPage = () => {
    ...
    const handleEdit = (vehicle) => {
        ...
        toast.info('صفحة التعديل قيد التطوير');
    };
    ...
    const handleStatusChange = async (vehicleId, newStatus) => {
        try {
            setActionLoading(true);
            const response = await vehicleService.updateVehicleStatus(vehicleId, newStatus);
    ...
    const confirmAssignment = async () => {
        ...
        try {
            setActionLoading(true);
            const response = await vehicleService.assignVehicle(selectedVehicleId, selectedDistributorId);
            ...
            >
                <Card className="bg-gradient-to-r from-blue-50 to-blue-100 border-blue-200">
                    <CardBody>
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-blue-600 text-sm font-medium">إجمالي المركبات</p>
                ...
                <Card className="bg-gradient-to-r from-green-50 to-green-100 border-green-200">
                    <CardBody>
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-green-600 text-sm font-medium">المركبات النشطة</p>
                ...
                <Card className="bg-gradient-to-r from-purple-50 to-purple-100 border-purple-200">
                    <CardBody>
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-purple-600 text-sm font-medium">المركبات المُعينة</p>
                                <p className="text-2xl font-bold text-purple-900">{statistics.assigned || 0}</p>
                            </div>
                ...
                <Card className="bg-gradient-to-r from-yellow-50 to-yellow-100 border-yellow-200">
                    <CardBody>
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-yellow-600 text-sm font-medium">في الصيانة</p>
                                <p className="text-2xl font-bold text-yellow-900">{statistics.maintenance || 0}</p>
                            </div>
