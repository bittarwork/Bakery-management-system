...
async function testDirectOrderCreation() {
  ...
  try {
    console.log('🧪 Testing direct order creation in database...');
    ...
    const orderItem = await OrderItem.create({
      ...
      notes: 'test item from direct script'
    }, { transaction });
    ...
    console.log('🎉 Complete order data:', JSON.stringify(completeOrder, null, 2));
