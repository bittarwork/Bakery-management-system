...
export const validateCreatePayment = [
  ...
  body("amount_eur")
    .optional()
    .isFloat({ min: 0 })
    .withMessage("المبلغ باليورو يجب أن يكون رقماً موجباً"),

  body("amount_syp")
    .optional()
    .isFloat({ min: 0 })
    .withMessage("المبلغ بالليرة السورية يجب أن يكون رقماً موجباً"),
  ...
  body("payment_date").isISO8601().withMessage("تاريخ الدفع غير صحيح"),
