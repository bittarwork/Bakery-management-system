-- ===========================================
-- Master Seeder - بذر البيانات الكامل
-- يشغل جميع seeders بالترتيب الصحيح
-- ===========================================

-- معلومات النظام
SELECT '🌱 بدء عملية بذر البيانات الكاملة...' AS message;
...
-- ===========================================
-- 1. بذر المستخدمين (Users)
-- ===========================================

SELECT '📥 1/8 - بذر بيانات المستخدمين...' AS step;
...
SELECT '✅ تم إكمال عملية بذر البيانات بنجاح!' AS final_status;
